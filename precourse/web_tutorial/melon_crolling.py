...
while True:
    try:
        more = driver.find_element(By.XPATH, '//*[@id="conts"]/div[3]/div[3]/button/span/span')
        more.click()
        time.sleep(0.3)
    except:
        break
...
list = soup.select('#conts > div.ltcont > div.wrap_list_artistplus.d_artist_list > ul > li')
...
for el in list:
    ...
    score = wrap_info.select_one('dd.consumer_list > table > tbody > tr').text.strip().split('\n')
